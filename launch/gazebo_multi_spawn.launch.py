...
def generate_launch_description():
    ...
    for robot in robots:
        ...
        # robot_prefix = 
        # robot_prefix_arg = DeclareLaunchArgument('robot_prefix', default_value=robot['name'])
        ...
        #         '-file', os.path.join('/home/jaeyong/ros2_ws/src/turtlebot3_multi_robot/models/turtlebot3_waffle/model.sdf'),
        #         '-entity', robot['name'],
